...
public func curry<First, Second, Third, Fourth, Fifth, Sixth, Result>(_ uncurried:
    @escaping (First, Second, Third, Fourth, Fifth, Sixth) -> Result)
...
public func curry<First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth, Result>(_ uncurried:
    @escaping (First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth) -> Result)
    -> (First) -> (Second) -> (Third) -> (Fourth) -> (Fifth) -> (Sixth) -> (Seventh) -> (Eighth) -> (Ninth) -> Result {

        return { first in { second in { third in { fourth in { fifth in { sixth in { seventh in { eighth in { ninth in
                                        return uncurried(first, second, third, fourth, fifth,
...
public func curry<First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth, Tenth, Result>(_ uncurried:
    @escaping (First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth, Tenth) -> Result)
    -> (First) -> (Second) -> (Third) -> (Fourth) -> (Fifth) ->
    (Sixth) -> (Seventh) -> (Eighth) -> (Ninth) -> (Tenth) -> Result {

        return { first in { second in { third in { fourth in { fifth in {
            sixth in { seventh in { eighth in { ninth in { tenth in
                                            return uncurried(first, second, third, fourth, fifth,
...
public func curry<First, Second, Third, Fourth, Fifth, Sixth,
                  Seventh, Eighth, Ninth, Tenth, Eleventh, Result>(_ uncurried:
    @escaping (First, Second, Third, Fourth, Fifth, Sixth, Seventh, Eighth, Ninth, Tenth, Eleventh) -> Result)
    -> (First) -> (Second) -> (Third) -> (Fourth) -> (Fifth) ->
